...
namespace VehicleCatalogMVCAssignment
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ApplicationDBContext>(options => options.UseSqlServer(Configuration.GetConnectionString("AppDBConnection")));
